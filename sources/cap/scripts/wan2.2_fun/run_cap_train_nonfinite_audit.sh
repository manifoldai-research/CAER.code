...
Environment:
  ...
  PYTHON_BIN=PATH        Python runtime (default: validated Python 3.10 runtime).
...
TRAIN_SCRIPT="$SCRIPT_DIR/train_control_camera_arm_actionmap_method1_nonfinite_audit.py"
